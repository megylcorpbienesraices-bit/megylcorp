...
|---|---|
| `QUANT_ENGINE_AUDIT_v1.57.0.md`, `VALIDACION_PRE_VPS_v1.57.0.md`, `RELEASE_MANIFEST_v1.57.0.json` | **Los exige el gate de release.** No aparecen en ningún grep porque el nombre se construye con la versión: `ROOT / f"QUANT_ENGINE_AUDIT_v{version}.md"`. Borrarlos rompe el empaquetado. |
